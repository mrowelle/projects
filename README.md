A few projects on data wrangling (exploratory data analysis using python), feature selection and data modelling
...
The projects here explores the length and breadth of different machine learning models for predicting the chances of Cardiovasular Diseases, Improving engagement by making targeted recommendations on a movies dataset, etc.
